            ...
            <div className="h-full p-6 md:p-10 rounded-3xl bg-[var(--bg-card)] border border-[var(--border-card)] backdrop-blur-md relative overflow-hidden flex flex-col justify-between group hover:border-[var(--border-card-hover)] transition-colors duration-500">
                ...
                <div>
                    ...
                    <p className="text-[var(--text-secondary)] mb-8 md:mb-12 text-base md:text-lg leading-relaxed max-w-md">
                        ...
                        I'm always open to discussing new opportunities, creative ideas, or just connecting.
                    </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-5 md:gap-6 h-full justify-center">
                    ...
                    <button
                        ...
                        className={`group w-full flex items-center justify-center gap-2 font-bold text-base md:text-lg py-3 md:py-4 px-6 md:px-8 rounded-2xl transition-all shadow-lg active:scale-95 transform 
                            ${status === 'submitting' ? 'bg-[var(--bg-card)] text-[var(--text-tertiary)] cursor-wait' : 
                              status === 'success' ? 'bg-green-600 hover:bg-green-500 text-white' :
                              status === 'error' ? 'bg-red-600 hover:bg-red-500 text-white' :
                              'bg-gradient-to-r from-violet-600 to-blue-600 hover:from-violet-500 hover:to-blue-500 hover:-translate-y-1 text-white'
                            }`}
                    >
                        {status === 'submitting' ? (
                            <>
                    ...
                    <input type="hidden" name="access_key" value="4a7c79e4-aa86-4f8c-a54c-4776e8701be5" />
                </form>
            </div>
        </TiltCard>
      </div>
